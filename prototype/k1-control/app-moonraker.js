...
import {SimulatedMoonrakerAdapter} from "./moonraker-adapter.js";

const adapter = new SimulatedMoonrakerAdapter();
let state;
...
function renderCalibration() {
  ...
  byId("restore-calibration").disabled = !calibration.canRestore;
}
...
async function send(script) {
  try {
    ...
    byId("readiness-title").textContent = "Commande simulée refusée";
