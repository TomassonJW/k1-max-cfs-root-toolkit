...
la plaque `PEI_TEXTURED_A`, le plateau à `60 °C`, la buse à `140 °C`, dix
minutes de stabilisation, un nettoyage stock borné jusqu'à `180 °C`, puis un
...
`k1_p001_t060_r001_n06x06`. La session Z utilise ensuite le chemin déjà installé
