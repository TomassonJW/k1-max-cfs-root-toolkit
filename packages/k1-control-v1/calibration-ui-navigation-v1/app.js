  ...
  byId("z-instruction").textContent = atLastStep
    ...
    : testing
      ...
      : phase === "mesh_ready"
        ...
        : phase === "starting_z"
          ? "Préparation du Z en cours : chauffe, homing et chargement du mesh qualifié."
          : phase === "z_confirmed"
            ? "Le jeu final est confirmé et la tête est remontée. Tu peux enregistrer le Z."
            : phase === "accepted"
              ? "Mesh 6 × 6 et Z enregistrés. La calibration est terminée."
              : "Le parcours Z n’est pas disponible dans cet état.";
}
