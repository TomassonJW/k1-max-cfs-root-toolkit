...
$metadata = [ordered]@{
    ...
    mode = 'strict_read_only_stock_unload_guard_adapter_validation'
...
echo 'LIVE_ADAPTER_READ_ONLY_OK'
'@
...
Write-Host "VALIDATION LIVE ADAPTATEUR CFS EN LECTURE SEULE : $SessionLabel"
Write-Host 'Aucun G-code, chauffage, mouvement, garde, service ou fichier distant ne sera utilise.'
...
Write-Host "LIVE_ADAPTER_READ_ONLY_CLOSED exit_code=$sshExitCode capture=$capturePath"
exit $sshExitCode
