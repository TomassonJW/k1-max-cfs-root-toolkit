...
| 3. Températures du G-code au chargement | **en place, déployé le 10 septembre à 11:07** | `KCTRL_MATERIAL_ALIGN` en première commande de `START_PRINT` écrit la température du fichier dans la fiche matière que le chargeur relit à chaque chargement ; prouvé sur la machine par un aller-retour `200 → 205 → 200` et un refus sur fiche absente. Pas encore observé sur un vrai chargement. Document 67, section 8. |
...
| 6. Zéro intervention | **pas encore** | Somme des points 2, 4 et 5 ; zéro Z du profil `11 × 11` à refaire (carré 280 × 280) avant toute impression qui compte. |
